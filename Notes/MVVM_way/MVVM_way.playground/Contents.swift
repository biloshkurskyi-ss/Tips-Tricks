...
resourses.append(Resource(index: 7, topic: "1st MVVM example", url: "https://github.com/sergVn/Tips-Tricks/tree/master/Notes/MVVM_way/MVVM_test", comment: "Test app for understanding"))
...
resourses.append(Resource(index: 11, topic: "2nd MVVM example", url: "https://github.com/sergVn/Tips-Tricks/tree/master/Notes/MVVM_way/MVVM_test_2", comment: "Test app 2"))
resourses.append(Resource(index: 12, topic: <#T##String#>, url: "https://www.toptal.com/ios/swift-tutorial-introduction-to-mvvm", comment: <#T##String?#>))
